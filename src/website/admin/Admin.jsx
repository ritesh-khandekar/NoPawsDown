    ...
    }
    {
      adminLogin && AdminData ?
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="container">
          <h2 className="text-black py-3 text-center"><i>Admin Dashboard</i></h2>
          <div class="container d-flex flex-wrap justify-content-around mt-4">
            <div class="rounded-3 p-3 shadow-sm text-center bg-white" style={{ minWidth: "30%" }}>
            ...
            <div class="rounded-3 p-3 my-5 shadow-sm text-center bg-white" style={{ minWidth: "30%" }}>
