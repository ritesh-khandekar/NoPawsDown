            ...
            <form className="mx-1 mx-md-4" onSubmit={handleSubmit}>
                ...
                <div className="d-flex flex-row align-items-center mb-4">
                    ...
                    <div className="form-outline flex-fill mb-0">
                        <input type="email" id="form3Example3c" className="form-control border border-primary text-secondary" onChange={(e) => setEmail(e.target.value)} placeholder="Your Email" />                                            </div>
                </div>

                <div className="d-flex flex-row align-items-center my-2">
                    <i className="fa mr-2 fa-lock fa-lg me-3 fa-fw text-secondary"></i>
                    <div className="form-outline flex-fill">
                        <input type="password" id="form3Example4c" className="form-control border border-primary text-secondary" onChange={(e) => setPassword(e.target.value)} placeholder="Password" />
                    </div>
                </div>
