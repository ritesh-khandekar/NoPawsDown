        ...
        <div className="col-md-6 col-lg-4 col-sm-10 rounded bg-white shadow p-3">
            ...
            <form className="mx-1 mx-md-4" autoComplete="off" autoSave="false" onSubmit={handleSubmit}>
                ...
                {/* <div className="d-flex flex-row align-items-center mb-4">
                    ...
                    <div className="form-outline flex-fill mb-0">
                        <input type="password" id="form3Example4cd" name="user[password2]" className="form-control text-primary border border-primary" onChange={(e)=> setPassword(e.target.value)} placeholder="Repeat Your Password" />
                    </div>
                </div> */}
